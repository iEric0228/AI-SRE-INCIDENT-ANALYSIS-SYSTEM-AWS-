...
def put_llm_invocation_metric(latency: float, success: bool, model_id: str = 'anthropic.claude-v2') -> None:
    """
...
def put_notification_delivery_metric(channel: str, success: bool, duration: float) -> None:
    ...
    # Emit duration
    put_metric(
        metric_name='NotificationDuration',
        value=duration,
        unit='Seconds',
        dimensions=dimensions
    )
