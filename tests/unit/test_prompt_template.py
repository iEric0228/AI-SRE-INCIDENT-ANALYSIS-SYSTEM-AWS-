...
class TestPromptTemplateStructure:
    ...
    def test_template_emphasizes_data_only_analysis(self):
        ...
        assert "ONLY on provided data" in PROMPT_TEMPLATE or "only on the provided data" in PROMPT_TEMPLATE.lower()
        assert "no speculation" in PROMPT_TEMPLATE.lower() or "do not make assumptions" in PROMPT_TEMPLATE.lower()
