...
import sys
import os
sys.path.insert(0, os.path.join(os.path.dirname(__file__), '../../src/deploy_context_collector'))
...
class TestLambdaHandler:
    ...
    def test_successful_change_retrieval(self, mock_cloudtrail_client):
        ...
        with patch('lambda_function.cloudtrail', mock_cloudtrail_client):
            with patch('lambda_function.ssm', MagicMock()):
                # Act
...
class TestClassifyChangeType:
    ...
    def test_classify_configuration(self):
        ...
        assert lambda_function.classify_change_type("UpdateFunctionConfiguration") == "configuration"
...
class TestCollectParameterStoreChanges:
    ...
    def test_collect_parameter_store_changes_success(self):
        ...
        with patch('lambda_function.ssm', mock_ssm):
            # Act
