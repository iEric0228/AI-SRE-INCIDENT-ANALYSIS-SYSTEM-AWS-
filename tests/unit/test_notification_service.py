...
class TestLambdaHandler:
    ...
    @patch('lambda_function.send_email_notification')
    def test_successful_notification_both_channels(self, mock_email, mock_slack, sample_analysis_report):
...
class TestSlackNotification:
    ...
    @patch('lambda_function.get_slack_webhook_url')
    @patch('requests.post')
    ...
    @patch('requests.post')
    @patch('time.sleep')
    def test_slack_fails_after_max_retries(self, mock_sleep, mock_post, mock_get_url, sample_analysis_report):
...
class TestSecretsRetrieval:
    ...
    def test_successful_secret_retrieval(self, mock_secrets_manager):
        ...
        # Arrange
        with patch('lambda_function.secrets_manager', mock_secrets_manager):
            # Act
    ...
    @patch('lambda_function.SLACK_SECRET_NAME', 'custom/secret/path')
    @patch('lambda_function.secrets_manager')
