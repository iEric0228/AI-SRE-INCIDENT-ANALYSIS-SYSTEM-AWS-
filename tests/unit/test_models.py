...
class TestIncidentRecord:
    ...
    def test_to_dynamodb_item(self):
        ...
        assert item["resourceArn"]["S"] == "arn:aws:ec2:us-east-1:123456789012:instance/i-1234567890abcdef0"
    ...
    def test_metrics_collector_output_invalid_duration_type(self):
        ...
        with pytest.raises((ValueError, TypeError)):
            MetricsCollectorOutput.from_dict({
                "status": "success",
                "metrics": [],
                "collectionDuration": "not-a-number"
            })
