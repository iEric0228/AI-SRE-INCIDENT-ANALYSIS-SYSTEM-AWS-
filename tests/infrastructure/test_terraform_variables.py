...
class TestObservabilityVariables:
    ...
    def test_log_retention_valid_values(self):
        ...
        for retention in valid_retentions:
            assert retention in [1, 3, 5, 7, 14, 30, 60, 90, 120, 150, 180, 365, 400, 545, 731, 1827, 3653]
        
        for retention in invalid_retentions:
            assert retention not in [1, 3, 5, 7, 14, 30, 60, 90, 120, 150, 180, 365, 400, 545, 731, 1827, 3653]
